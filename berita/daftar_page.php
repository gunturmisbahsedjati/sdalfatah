    ...
    <section id="recent-blog-pengumuman" class="recent-blog-posts">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <?php
          $sqlPengumuman = mysqli_query($myConnection, "select * from tb_pengumuman order by created_date desc");
          while ($viewPengumuman = mysqli_fetch_array($sqlPengumuman)) { ?>
            <div class="col-lg-4">
              <div class="post-box">
                ...
                <a href="detail/<?= $viewPengumuman['slug_pengumuman'] ?>" target="_blank" class="readmore stretched-link mt-auto"><span>Lihat detail...</span><i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          <?php } ?>
        </div>
