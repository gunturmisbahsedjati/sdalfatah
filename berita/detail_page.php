...
$viewNews = mysqli_query($myConnection, "select tb_berita.*, tb_pengguna.nama_pengguna from tb_berita left join tb_pengguna on tb_pengguna.id_pengguna = tb_berita.created_by where tb_berita.slug_berita = '$slug' and tb_berita.soft_delete = 0");
$title = "Berita";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php
        if (mysqli_num_rows($viewNews) > 0) {
          $rowPengumuman = mysqli_fetch_array($viewNews)

        ?>

          <header class="section-header">
            <!-- <h2>Portfolio</h2> -->
            <p><?= $rowPengumuman['judul_berita'] ?></p>
          </header>
          ...
          <article class="entry entry-single">
            ...
            <div class="entry-content">
              <img src="../../assets/img<?= $rowPengumuman['foto_berita'] ?>" alt="" class="img-fluid">
