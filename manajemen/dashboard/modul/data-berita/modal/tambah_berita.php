...
<form action="setBerita" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Judul Berita" name="judul_berita" aria-describedby="defaultFormControlHelp" required>
        </div>
        <div class="mb-3">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                <div>
                    <span class="btn btn-theme04 btn-file">
                        ...
                        <input type="file" name="foto_berita" class="default">
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        <button type="submit" name="tambahBerita" class="btn btn-success">Simpan</button>
