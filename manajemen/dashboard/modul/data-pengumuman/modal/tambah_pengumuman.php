...
<form action="setPengumuman" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
    <div class="modal-header modal-header-tambah">
        <h5 class="modal-title"><i class="fa fa-plus"></i> Tambah Pengumuman</h5>
    </div>
    <div class="modal-body">
        <div class="mb-3">
            <label class="form-label">Judul Pengumuman</label>
            <input type="text" class="form-control" placeholder="Judul Pengumuman" name="judul_pengumuman" aria-describedby="defaultFormControlHelp" required>
        </div>
        <div class="mb-3">
            ...
            <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                <div>
                    <span class="btn btn-theme04 btn-file">
                        ...
                        <input type="file" name="foto_pengumuman" class="default">
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="modal-footer">
        <button type="submit" name="tambahPengumuman" class="btn btn-success">Simpan</button>
