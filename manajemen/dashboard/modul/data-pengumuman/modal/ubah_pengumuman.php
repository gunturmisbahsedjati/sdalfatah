        ...
        <form action="setPengumuman" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Judul Pengumuman" name="judul_pengumuman" aria-describedby="defaultFormControlHelp" value="<?= $pengumuman['judul_pengumuman'] ?>" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Deskripsi Pengumuman</label>
                    <div class="">
                        <textarea name="isi_pengumuman" id="ubah_isi_pengumuman"><?= $pengumuman['isi_pengumuman'] ?></textarea>
                    </div>
                </div>
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        ...
                        <div>
                            <span class="btn btn-theme04 btn-file">
                                ...
                                <input type="file" name="foto_pengumuman" value="<?= $pengumuman['foto_pengumuman'] ?>" class="default">
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="ubahPengumuman" class="btn btn-success">Simpan</button>
