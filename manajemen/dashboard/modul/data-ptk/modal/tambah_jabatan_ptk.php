...
<form action="setPTK" method="post" role="form" enctype="multipart/form-data" autocomplete="off">
    <div class="modal-header modal-header-tambah">
        <h5 class="modal-title"><i class="fa fa-plus"></i> Tambah Jabatan</h5>
    </div>
    <div class="modal-body">
        <div class="mb-3">
            <label class="form-label">Nama Jabatan</label>
            <input type="text" class="form-control" placeholder="Nama Jabatan" name="nama_jabatan" aria-describedby="defaultFormControlHelp" required>
        </div>
    </div>
