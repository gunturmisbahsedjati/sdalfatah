...
<head>
  ...
  <title>Login Web Portal | SD Al-Fatah Surabaya</title>
...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" id="formInput" autocomplete="off">

        <h2 class="form-login-heading"><img src="./img/sd.png" alt="" height="100px"><br><br>sign in now</h2>
        <div class="login-wrap">
          ...
          <div class="text-center">
            &copy; <?= date('Y') ?> SD Al-Fatah Surabaya
          </div>
        </div>
        <!-- Modal -->
