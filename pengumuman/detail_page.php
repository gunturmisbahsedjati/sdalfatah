...
$slug = substr($actual_link, strrpos($actual_link, '/') + 1);
$viewGaleri = mysqli_query($myConnection, "select tb_pengumuman.*, tb_pengguna.nama_pengguna from tb_pengumuman left join tb_pengguna on tb_pengguna.id_pengguna = tb_pengumuman.created_by where tb_pengumuman.slug_pengumuman = '$slug' and tb_pengumuman.soft_delete = 0");
$title = "Pengumuman";
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main">
    ...
    <section id="blog" class="blog">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php
        if (mysqli_num_rows($viewGaleri) > 0) {
          $rowPengumuman = mysqli_fetch_array($viewGaleri)

        ?>

          <header class="section-header">
            <!-- <h2>Portfolio</h2> -->
            <p><?= $rowPengumuman['judul_pengumuman'] ?></p>
          </header>
          ...
          <article class="entry entry-single">
            ...
            <div class="entry-content">
              <img src="../../assets/img<?= $rowPengumuman['foto_pengumuman'] ?>" alt="" class="img-fluid">
              <div class="entry-meta" style="margin-top: 2em;">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i>
                    <span class="text-secondary"><?= $rowPengumuman['nama_pengguna'] ?></span>
                  </li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <span class="text-secondary"><time datetime="2020-01-01"><?= hariTgl(tanggal($rowPengumuman['created_date'])) . ', ' . Indonesia2Tgl($rowPengumuman['created_date']) ?></time></span></li>
                </ul>
              </div>
              <?= $rowPengumuman['isi_pengumuman'] ?>
            </div>
