...
$sqlPTK = mysqli_query($myConnection, "select tb_ptk.*, tb_jabatan_ptk.nama_jabatan 
                            from tb_ptk
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <!-- <h2>Kepala Sekolah, Guru dan Staf</h2> -->
          <p>Kepala Sekolah, Guru dan Staf</p>
        </header>

        <div class="row gy-4">
          <?php
          $delay = 100;
          while ($viewPtk = mysqli_fetch_array($sqlPTK)) { ?>
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="<?= $delay ?>">
              <div class="member">
                <div class="member-img">
                  <img src="../assets/img<?= $viewPtk['foto'] ?>" class="img-fluid" alt="">
                  <div class="social">
                ...
                <div class="member-info">
                  <h4><?= $viewPtk['nama_ptk'] ?></h4>
                  <span><?= $viewPtk['nama_jabatan'] ?></span>
                </div>
              </div>
            </div>
          <?php
