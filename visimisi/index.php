...
$viewVisiMisi = mysqli_fetch_array(mysqli_query($myConnection, "select visimisi, foto_visimisi from tb_profil_sekolah where id_profil = 1"));
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="entries">
          ...
          <article class="entry entry-single">
            ...
            <div class="entry-img">
              <img src="../assets/img/<?= $viewVisiMisi['foto_visimisi'] ?>" alt="" class="img-fluid">
            </div>

            <h2 class="entry-title">
              <a href="#">Visi dan Misi SD AL-FATAH SURABAYA</a>
            </h2>
            <div class="entry-content">
              <?php
              // echo '<pre>';
              echo nl2br($viewVisiMisi['visimisi']);
              // echo '</pre>';
              ?>
            </div>
